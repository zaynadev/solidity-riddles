...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
			await attackerContract.connect(attackerWallet).sendNFT(NFTToStakeContract.address,depositoorContract.address,rewardTokenContract.address);
			const ONE_DAY_IN_SECS = 24 * 60 * 60;
    		unlockTime = (await time.latest()) + ONE_DAY_IN_SECS;
